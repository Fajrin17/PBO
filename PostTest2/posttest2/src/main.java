...
public class main {
    ...
    static void addPos() throws NumberFormatException, IOException {
        ...
        System.out.println("Masukkan Hasil Pantauan Dalam Desimal");
        System.out.print("> ");
        hasilPantauan = Double.parseDouble(input.readLine());

        Pos pos = new Pos(idPos, lokasi, jumlahAlat, hasilPantauan);
        listPos.add(pos);
