...
public class main {
    ...
    static void menuDisplay() throws NumberFormatException, IOException {
        ...
        boolean ulang1 = true;
        while (ulang1 == true) {
            System.out.println("Pilih Tipe Display");
            System.out.println("================================================================");
    ...
    static void displayDetail() {
        if (listPos.size() != 0) {
            ...
            for (Pos pos : listPos) {
                System.out.println("[" + i + "]");
                if (pos instanceof PosPantauHujan) {
                    ((PosPantauHujan) pos).tampil(true);
                } else if (pos instanceof PosPantauanKelembapan) {
                    ((PosPantauanKelembapan) pos).tampil(true);
                }
                i++;
            }
        } else {
    ...
    static void addPosHujan() throws NumberFormatException, IOException {
        ...
        PosPantauHujan posHujan = new PosPantauHujan(idPos, lokasi, jumlahAlat, hasilPantauan, date);
    ...
    static void addPosKelembapan() throws NumberFormatException, IOException {
        ...
        PosPantauanKelembapan posKelembapan = new PosPantauanKelembapan(idPos, lokasi, jumlahAlat, hasilPantauan, date);
